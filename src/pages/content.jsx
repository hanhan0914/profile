...
<TypeAnimation
        ...
        style={{  display: 'block', minHeight: '200px',color:'	#FF8F59',fontWeight:'500' }}
...
<TypeAnimation
      ...
      "Efficient communication and problem-solving.constantly improving my technical abilities.  My psychology background enriches my understanding of human-computer interaction and UX design concepts.",
        ...
        speed={{ type: 'keyStrokeDelayInMs', value: 90 }}
        omitDeletionAnimation={true}
        style={{  display: 'block', minHeight: '200px',color:'#84C1FF',fontWeight:'500' }}
...
<TypeAnimation
        ...
        speed={{ type: 'keyStrokeDelayInMs', value: 90 }}
        omitDeletionAnimation={true}
        style={{  display: 'block', minHeight: '200px',color:'	#FFFFAA',fontWeight:'500' }}
...
<TypeAnimation
        ...
        speed={{ type: 'keyStrokeDelayInMs', value: 90 }}
        omitDeletionAnimation={true}
        style={{  display: 'block', minHeight: '200px',color:'	#53FF53',fontWeight:'500' }}
